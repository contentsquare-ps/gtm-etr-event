...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Contentsquare - ETR Event",
  "brand": {
  ...
  "description": "Trigger an ETR (Event Triggered Recording) Event to Contentsquare",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "etrEventName",
    "displayName": "ETR Event Name (Max 255 chars)",
    ...
    "help": "Enter the name of the event you want to send which will trigger an ETR event that will save the recorded session of the visitor."
  },
  {
    "type": "SELECT",
    "name": "etrEventType",
    "displayName": "ETR Event Type",
...
var etrEventName = data.etrEventName;
var etrEventType = data.etrEventType;
let eventTypePrefix = "";

if (typeof etrEventName != "undefined") {
    if (etrEventType === "page") {
        eventTypePrefix = "@ETP@";
    } else if (etrEventType === "session") {
        eventTypePrefix = "@ETS@";
    }

    if (eventTypePrefix) {
        _uxaPush(["trackEventTriggerRecording", eventTypePrefix + etrEventName]);
    }
}
